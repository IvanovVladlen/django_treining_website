...
class OrderAdm(admin.ModelAdmin):
    list_display = ('id', 'opder_status', 'order_name', 'order_phone', 'order_dt')
    list_display_links = ('id', 'order_name')
    search_fields = ('id', 'order_name', 'order_phone','order_dt')
    list_filter = ('opder_status',)
    list_editable = ('opder_status', 'order_phone')
    list_per_page = 10
    list_max_show_all = 100
    fields = ('id', 'opder_status', 'order_dt', 'order_name', 'order_phone')
